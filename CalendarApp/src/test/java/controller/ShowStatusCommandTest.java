...
public class ShowStatusCommandTest {
   ...
   */
  private String captureStatusOutput(boolean status) {
  ...
  /**
   * Captures and returns the output generated by executing the show status command.
   *
   * @param command the command arguments passed to the show status command.
   * @param cal     The ICalendar instance on which the command is executed.
   * @return the captured string output from the show status command execution.
   * @throws Exception if executing the command fails or an error occurs during output capture.
   */
