...
public class CreateCommandTest {
  ...
  public void recurringEventcommand() throws Exception {
    try {
      ...
      assertEquals(e.getMessage(), "error :'for' must be followed by a " +
   ...
   *
   * @param command The command arguments passed to the print command.
   * @param cal     The ICalendar instance on which the command is executed.
   * @return The captured output as a String from the execution of the print command.
